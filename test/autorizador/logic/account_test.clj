...
(def cash-acc {:id          #uuid "09693c78-9c1d-483b-8306-fb1e430964b3"
               :customer-id #uuid "d740f20a-1074-4db0-896d-fa2418e8cf34"
               :transactions
               [{:id        #uuid "4dae55f1-f425-4784-b887-b5429700fb95"
                 :source-id #uuid "1252c9cb-cb9a-45a5-9cf0-f60f2803e1c1"
                 :amount    -10.00M
                 :category  :cash}]
               :balances    {:food 0.00M :meal 0.00M :cash 10.00M}})
...
(def cash-acc+tr {:id          #uuid "09693c78-9c1d-483b-8306-fb1e430964b3"
                  :customer-id #uuid "d740f20a-1074-4db0-896d-fa2418e8cf34"
                  :transactions
                  [{:id        #uuid "4dae55f1-f425-4784-b887-b5429700fb95"
                    :source-id #uuid "1252c9cb-cb9a-45a5-9cf0-f60f2803e1c1"
                   ...
                   {:id        #uuid "de622c76-e119-4682-b5ff-5a6fa6eb353b"
                    ...
                    :amount    8.50M
                    :category  :cash}]
                  :balances    {:food 0.00M :meal 0.00M :cash 1.50M}})
...
(deftest with-new-transaction
  ...
  (testing "Cash transaction"
    (is (= (:transactions cash-acc+tr)
           (logic.account/with-new-transaction cash-acc cash-tr mocked-random-uuid)))))
...
(deftest with-update-balance
  ...
  (testing "Updates cash balance"
    (is (= (:balances cash-acc+tr) (:balances (logic.account/with-updated-balance cash-acc cash-tr))))))
...
(deftest updated-account
  (testing "Append transaction and update balances"
    ...
    (is (= cash-acc+tr (logic.account/updated-account cash-acc cash-tr mocked-random-uuid)))))
